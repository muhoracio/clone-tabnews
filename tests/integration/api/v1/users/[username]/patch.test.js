...
describe("PATCH /api/v1/users/[username]", () => {
  describe("Anonymous user", () => {
    ...
    test("With duplicated 'username'", async () => {
      const user1Response1 = await fetch("http://localhost:3000/api/v1/users", {
        method: "POST",
        headers: {
      ...
      expect(user1Response1.status).toBe(201);
    ...
    test("With case mismatch in 'username'", async () => {
      const user1Response1 = await fetch("http://localhost:3000/api/v1/users", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
